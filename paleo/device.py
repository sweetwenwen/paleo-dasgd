...
ETHERNET_20 = Network('Ethernet',   bandwidth=25 * _Gbps)
...
NVLINK      = Network('nvlink',     bandwidth=2400 * _Gbps)
...
# Predefined devices.
GPU_V100 = Device(
    'V100', clock=1230, peek_gflop=7800, mem_bandwidth=900.1, is_gpu=True)
