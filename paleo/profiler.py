...
@click.option('--device_name',      default='TITAN_X', type=click.Choice(['V100','TITAN_X','K20','K20X','K40','K80','GEFORCE_780_TI','GEFORCE_750_M','CPU_I7']))
@click.option('--network_name',     default='ethernet',type=click.Choice(['aws','ethernet','ethernet20','infiniband','pcie2','pcie3']))
...
@click.option('--parallel',         default='data',type=click.Choice(['data', 'model', 'hybrid']))
